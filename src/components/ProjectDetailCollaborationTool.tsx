...
export function ProjectDetailCollaborationTool({ onBack }: ProjectDetailCollaborationToolProps) {
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-[#202632] leading-relaxed max-w-3xl">
            GitHub UI와 유사한 협업 도구를 Figma 기획서 기반으로 구현했습니다. 이 과정에서 기존 필터 기능의 비효율성을 개선하고, 복잡한 상태를 효율적으로 관리하는 것을 주요 과제로 설정했습니다.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="text-[#202632]" style={{ fontWeight: 600 }}>
                React, Zustand, Immer, React-Query, Caching
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-12 rounded-2xl text-center">
              ...
              <div className="text-[5rem] text-[#0064FF] mb-4" style={{ fontWeight: 700 }}>
                80%
              </div>
              <div className="text-lg text-[#202632]" style={{ fontWeight: 600 }}>
                네트워크 요청 수 감소
              </div>
              <div className="mt-4 text-[#717182]">
                5회 → 1회
              </div>
            </div>
            ...
            <div>
              <div className="space-y-6">
                <p className="text-[#202632] leading-relaxed">
                  필터 기능이 옵션 변경 시마다 불필요한 API를 4~5회 중복 호출하여 UX 저해 및 서버 부하를 유발했고, 
                  페이지 이동 시 메타데이터를 반복 요청하는 중복도 발견했습니다. 
                  아키텍처를 개선하여 서버 부하를 줄이고 사용자 경험(UX)을 향상시키는 것이 목표였습니다.
                </p>

                <p className="text-[#202632] leading-relaxed">
                  '상세 필터 모달'을 재설계하여 '적용' 시점에만 1회 요청하도록 변경했고, 
                  Zustand <code className="bg-[#F9FAFB] px-2 py-1 rounded text-sm">persist</code> 미들웨어로 메타데이터를 로컬 스토리지에 캐싱했습니다.
                </p>

                <p className="text-[#202632] leading-relaxed">
                  <strong>네트워크 요청을 80% 감소</strong>시켰고, 캐싱 전략으로 중복 API 호출을 원천 차단하여 
                  페이지 로딩 속도를 단축하고 서버 부하를 경감시켰습니다.
                </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-[1.25rem] text-[#0064FF]" style={{ fontWeight: 600 }}>
                  캐싱을 통한 중복 요청 제거
                </h3>
              </div>
              
              <p className="text-[#202632] leading-relaxed mb-6">
                페이지 이동 시마다 반복 요청되던 필터 메타데이터의 중복을 발견했습니다. Zustand의 <code className="bg-[#F9FAFB] px-2 py-1 rounded text-sm">persist</code> 미들웨어를 활용, 메타데이터를 로컬 스토리지에 캐싱하여 불필요한 API 호출을 원천 차단하고 로딩 속도를 단축했습니다.
              </p>

              {/* Code Block Placeholder */}
              <div className="bg-[#202632] p-6 rounded-xl overflow-x-auto">
                <div className="text-sm text-gray-400 mb-2">zustand-persist-example.ts</div>
    ...
    }),
    {
      name: 'filter-metadata-storage',
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <p className="text-[#202632] leading-relaxed mb-6">
                <code className="bg-[#F9FAFB] px-2 py-1 rounded text-sm">useDataFetch</code> 커스텀 훅으로 API 로직을 추상화하고, 오류 발생 시 <code className="bg-[#F9FAFB] px-2 py-1 rounded text-sm">Zustand</code> 전역 스토어에 상태를 업데이트했습니다. <code className="bg-[#F9FAFB] px-2 py-1 rounded text-sm">ErrorToast</code> 컴포넌트가 이 스토어를 구독하여, 앱 전역에서 일관된 에러 피드백을 제공하도록 구현했습니다.
              </p>

              {/* Error Toast Screenshot Placeholder */}
              <div className="bg-gradient-to-br from-red-50 to-orange-50 p-8 rounded-xl">
                <div className="bg-white border-2 border-red-200 p-4 rounded-lg shadow-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-sm text-[#202632] mb-1" style={{ fontWeight: 600 }}>
                        오류가 발생했습니다
                      </div>
