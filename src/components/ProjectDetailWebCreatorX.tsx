      ...
      <section className="py-24 px-6 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-[#202632] leading-relaxed max-w-3xl">
            드래그 앤 드롭 기능을 통해 사용자가 시각적으로 웹사이트를 디자인하고
            만들 수 있는 No-code 웹 빌더입니다.
          </p>
        </div>
      </section>
        ...
        >
          ...
          <div className="bg-[#F9FAFB] p-8 rounded-2xl">
            <p className="text-[#202632] leading-relaxed text-lg mb-4">
              팀은 FE 3명, BE 0명으로 구성되어 MVP에 필수적인 DB, 서버, 배포
              인프라 전체가 부재한 심각한 병목 상황에 직면했습니다. 팀장으로서
              이 기술 공백을 해결하고, 팀원들이 FE 개발에만 100% 집중할 수 있는
              환경을 구축하는 것을 최우선 과제로 삼았습니다.
            </p>
            <p className="text-[#202632] leading-relaxed text-lg mb-4">
              프론트엔드 역할을 넘어 AWS CodeDeploy, Nginx, PM2, Shell Script를
              통합하여 Blue/Green 무중단 배포 파이프라인 전체를 주도적으로
              설계하고 구축했습니다. 'curl'을 이용한 Health Check 자동화
              스크립트를 작성하여 안정성을 확보했습니다.
            </p>
            <p className="text-[#202632] leading-relaxed text-lg">
              배포 중 오류 응답 0%의{" "}
              <strong>'Zero Downtime'을 객관적으로 증명</strong>했으며, 배포
              속도를 45% 단축했습니다. 팀원들은 인프라 걱정 없이 'git
              push'만으로 개발에 몰입할 수 있는 환경을 제공하여{" "}
              <strong>팀 생산성을 극대화</strong>했습니다.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <span
                className="px-4 py-2 bg-white rounded-full text-sm text-[#202632]"
                style={{ fontWeight: 500 }}
              >
                FE 3명, BE 0명
              </span>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              <h3
                className="text-[1.25rem] mb-4 text-[#0064FF]"
                style={{ fontWeight: 600 }}
              >
                아키텍처 설계
              </h3>
              <p className="text-[#202632] leading-relaxed mb-4">
                AWS CodeDeploy, Nginx 리버스 프록시, PM2를 통합하여 안정적인
                무중단 배포 파이프라인을 구축했습니다.
              </p>
              <p className="text-[#202632] leading-relaxed">
                GitHub Actions로 CI/CD를 자동화하여 개발자가 git push만으로 전체
                배포 프로세스가 실행되도록 했습니다.
              </p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <p className="text-[#202632] leading-relaxed mb-4">
                배포 안정성을 위해 Shell Script를 작성했습니다. 'curl'로 신규
                서버의 /health 엔드포인트를 10회 검증하고, 검증 성공 시에만
                Nginx 설정을 동적으로 변경하여 트래픽을 전환하는 제어 로직을
                구현했습니다.
              </p>
              <div className="mt-6 space-y-2">
                <div className="flex items-center gap-2 text-sm text-[#717182]">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl text-center">
              <div
                className="text-sm text-[#717182] mb-3"
                style={{ fontWeight: 500 }}
              >
                배포 다운타임
              </div>
              <div
                className="text-[3rem] text-[#0064FF] mb-2"
                style={{ fontWeight: 700 }}
              >
                0%
              </div>
              <div
                className="text-sm text-[#202632]"
                style={{ fontWeight: 500 }}
              >
                달성
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-teal-50 p-8 rounded-2xl text-center">
              ...
              <div
                className="text-[2rem] text-[#0064FF] mb-2"
                style={{ fontWeight: 700 }}
              >
                극대화
              </div>
