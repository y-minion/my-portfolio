...
export function ProjectDetailAutomationMachine() {
   ...
   */
  const tags = ["SolidWorks", "ANSYS", "3D 프린팅"];
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#202632] leading-relaxed text-lg mb-4">
              졸업 작품 '자동화 소분 기계' 제작 중, 제어 모듈 담당 팀원이
              이탈하여 프로젝트가 중단될 위기에 처했습니다. 전공 외 분야인 모터
              제어 기능을 구현해야 하는 시급한 상황에서, 즉시 유튜브와
              구글링으로 관련 기술을 독학하여 제어 로직을 직접 구현하고 남은
              팀원들과 협력해 시스템을 성공적으로 통합했습니다.
            </p>

            <p className="text-[#202632] leading-relaxed text-lg mb-4">
              팀장으로서 기획, 일정 관리, 하드웨어 설계를 주도했으며,
              SolidWorks로 맞춤형 부품을 설계하고 ANSYS로 안정성을 확보한뒤 직접
              3D프린터를 이용해 부품을 제작했습니다. 최종적으로 기계의 안정적인
              구동을 실현하여 프로젝트를 성공적으로 마쳤으며,
              <strong>
                제한된 상황에서도 프로젝트를 완성할 수 있는 방법을 알 수
                있었습니다.
              </strong>
            </p>
            ...
            <div className="bg-[#F9FAFB] rounded-xl p-6 border-l-4 border-[#0064FF]">
              ...
              <div className="space-y-2">
                <p className="text-[#202632] leading-relaxed text-lg mb-4">
                  <strong>• 팀장 역할:</strong> 프로젝트 기획, 일정 관리,
                  하드웨어 설계 주도
                </p>
                <p className="text-[#202632] leading-relaxed text-lg mb-4">
                  <strong>• 위기 대응:</strong> 팀원 이탈 시 제한된 상황에서
                  모터 제어 구현
                </p>
                <p className="text-[#202632] leading-relaxed text-lg mb-4">
                  <strong>• 기술 융합:</strong> 모터 제어 + 3D 프린팅 맞춤 부품
                  설계
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                ...
                안정성을 검증했습니다. 3D 프린팅을 활용하여 맞춤형 부품을 직접
                제작하고 조립했습니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                ...
                소분기계의 영상 인식 카메라의 좌표 시스템을 설계 했습니다.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#F9FAFB] to-white rounded-xl p-8 border border-gray-200">
            ...
            <div className="space-y-4">
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                졸업작품 프로젝트의 팀장으로서 전체 프로세스를 주도하며 기획부터
                설계, 제작, 테스트까지 경험했습니다.
              </p>
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                프로젝트 중반 팀원의 이탈로 모터 제어 부분에 공백이 생겼을 때,
                빠르게 상황을 파악해 남은 팀원들과 일정을 조율해 프로젝트를
                마무리 할 수 있었습니다. 이 과정에서{" "}
                <strong>새로운 기술을 빠르게 습득하고 적용하는 능력</strong>과
                <strong>문제 해결을 위한 적극적인 자세</strong>를 키울 수
                있었습니다.
              </p>
            </div>
          </div>
