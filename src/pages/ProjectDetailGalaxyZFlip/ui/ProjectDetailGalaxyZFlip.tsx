        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#202632] leading-relaxed text-lg mb-4">
              'GALAXY Z FLIP 개선 설계' 프로젝트를 진행하며 기존 제품을 사용자
              관점에서 직접 사용해본 결과, 힌지 구조의 복잡성과 무게감 등
              구조적인 불편함을 발견했습니다. 사용자가 느끼는 이러한 불편함을
              해소하고 편의성을 높이기 위해, 제품 구조를 면밀히 분석하여
              불편함의 원인을 파악했습니다.
            </p>

            <p className="text-[#202632] leading-relaxed text-lg mb-4">
              GALAXY Z FLIP 1 모델을 역설계하여{" "}
              <strong>세 가지 주요 개선</strong>을 수행했습니다. 힌지 구조
              단순화 및 티타늄 소재 적용 등 부품을 최적화하는 재설계 작업을 통해
              경량화 및 내구성을 향상시켰으며, 프레임 구조 변경을 통해 언더컷
              문제를 해결했습니다. 이 개선 설계를 통해{" "}
              <strong>
                사용자의 불편함을 실질적으로 줄이고 제품의 전반적인 편의성을
                향상
              </strong>
              시키는 성과를 거두었습니다.
            </p>
            ...
            <div className="bg-[#F9FAFB] rounded-xl p-6 border-l-4 border-[#0064FF]">
              ...
              <div className="space-y-2">
                <p className="text-[#202632] leading-relaxed text-lg mb-4">
                  <strong>1. 힌지 구조 단순화:</strong> 복잡한 부품 수를 줄여
                  조립성 향상
                </p>
                <p className="text-[#202632] leading-relaxed text-lg mb-4">
                ...
                <p className="text-[#202632] leading-relaxed text-lg mb-4">
                  <strong>3. 언더컷 문제 해결:</strong> 프레임 구조 변경으로
                  제조 용이성 확보
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                실제 제품을 분해하고 SolidWorks로 3D 모델링을 진행했습니다. 각
                부품의 형상과 조립 방식을 분석하여 기존 설계의 장점과 개선점을
                파악했습니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                ANSYS 구조 해석을 통해 개선된 힌지 구조의 강도와 내구성을
                검증했습니다. 리브 보강 설계를 적용하여 강성을 유지하면서도
                경량화를 달성했습니다.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                기존 GALAXY Z FLIP 1의 힌지는 여러 개의 작은 부품으로 구성되어
                있어 조립이 복잡하고 내구성 문제가 발생할 수 있었습니다. 힌지
                구조를 재설계하여 부품 수를 줄이고, 조립 공정을 단순화했습니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                기존 스테인리스 스틸 대신 티타늄 소재를 적용하여 무게를
                줄이면서도 더 높은 강도와 내식성을 확보했습니다. ANSYS 해석을
                통해 충분한 구조적 안정성을 검증했습니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                기존 프레임 구조의 언더컷은 사출 성형 시 금형 분리를 어렵게
                만들었습니다. 프레임 구조를 변경하여 언더컷을 제거하고, 리브
                보강을 추가하여 강성 저하 없이 제조 용이성을 확보했습니다.
              </p>
            </div>
          </div>
        </div>
