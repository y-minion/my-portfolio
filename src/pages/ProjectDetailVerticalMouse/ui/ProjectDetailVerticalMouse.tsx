        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#202632] leading-relaxed text-lg mb-4">
              CAE 경진대회에서 버티컬 마우스의 최적 각도를 찾는 프로젝트를
              진행했습니다. '45도'가 손목에 가장 무리가 적을 것이라는 초기
              가설을 세우고, 이를 ANSYS 구조 해석을 통해 검증하는 것이
              목표였습니다. SolidWorks로 다양한 각도의 모델을 만들고, ANSYS를
              사용해 각 모델이 손목의 정중 신경에 가하는 응력을 정밀하게
              분석했습니다.
            </p>
            ...
            <p className="text-[#202632] leading-relaxed text-lg mb-4">
              해석 결과, 초기 가설과 달리{" "}
              <strong>
                60도 각도가 손목의 정중 신경에 가장 적은 응력을 가한다
              </strong>
              는 예상 밖의 결과를 도출하여 데이터를 기반으로 최적의 설계를
              증명했습니다.
            </p>
            ...
            <div className="bg-[#F9FAFB] rounded-xl p-6 border-l-4 border-[#0064FF]">
              ...
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                초기 가설과 다른 결과를 얻었으나, 데이터를 신뢰하고 분석 결과를
                통해 60도 각도가 인체공학적으로 최적임을 객관적으로
                증명했습니다. 이는 가설에 얽매이지 않고 데이터 기반 의사결정의
                중요성을 보여줍니다.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                ANSYS를 활용한 유한요소해석(FEA)을 통해 다양한 각도에서 손목
                정중 신경에 가해지는 응력을 정량적으로 측정하고 비교했습니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632] leading-relaxed text-lg mb-4">
                SolidWorks로 버티컬 마우스의 3D 모델을 설계하고, 각도 변화에
                따른 다양한 설계안을 생성하여 해석에 활용했습니다.
              </p>
            </div>
          </div>
        </div>
