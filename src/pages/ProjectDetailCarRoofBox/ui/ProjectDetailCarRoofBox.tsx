        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#202632] leading-relaxed text-lg mb-4">
              CAE 경진대회에서 자동차 루프 박스(툴레)가 유발하는 후류 현상과
              풍절음 문제를 발견했습니다. CFD(전산유체역학) 해석을 통해 문제를
              분석하고, 설계를 변경하여 연비를 개선하는 것이 목표였습니다. ANSYS
              CFD로 기존 모델의 공기 저항을 분석한 후, 루프 스포일러를 제거하고
              와류 발생기를 장착하는 설계를 채택하여 후방 공기 저항을 효과적으로
              줄이는 방안을 도출했습니다.
            </p>

            <p className="text-[#202632] leading-relaxed text-lg mb-4">
              최종 개선안은{" "}
              <strong>항력을 30.56% 감소시키고 연비를 약 30% 향상</strong>시키는
              정량적 성과를 달성하여 대회에서 입상했습니다.
            </p>
            ...
            <div className="bg-[#F9FAFB] rounded-xl p-6 border-l-4 border-[#0064FF]">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[#202632] leading-relaxed text-lg mb-4">
                  <strong>• 설계 개선:</strong> 루프 스포일러 제거 + 와류 발생기
                  장착
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632]">
                ANSYS CFD를 활용한 전산유체역학 해석을 통해 자동차 루프 박스
                주변의 공기 흐름과 후류 현상을 분석하고, 항력 계수를 정량적으로
                측정했습니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-[#202632]">
                ...
                다양한 설계안을 시뮬레이션하여 최적의 공기역학적 형상을
                도출했습니다.
              </p>
            </div>
          </div>
